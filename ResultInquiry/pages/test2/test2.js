...
Page({
  ...
  data: {
    ...
    catalogs: [
      {
        "catalogText": "https://rb.sunlands.com/images/ResultInquiryImages/test2wz1.png",
        "catalogBorder": "https://rb.sunlands.com/images/ResultInquiryImages/b.png",
        "select": 1
      },
      {
        "catalogText": "https://rb.sunlands.com/images/ResultInquiryImages/test2wz2.png",
        "catalogBorder": "https://rb.sunlands.com/images/ResultInquiryImages/b.png",
        "select": 2
      },
      {
        "catalogText": "https://rb.sunlands.com/images/ResultInquiryImages/test2wz3.png",
        "catalogBorder": "https://rb.sunlands.com/images/ResultInquiryImages/b.png",
        "select": 3
      },
    ],
  ...
  DownPage: function () {
    ...
    if (this.data.catalogSelect == 0) {
      ...
      wx.navigateTo({
        url: '../test3/test3?openid=' + this.data.openid + "&resultImg=" + this.data.resultImg,
      })
    }
  },
  /**
